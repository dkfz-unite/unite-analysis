    ...
    where TContext: SamplesContext
{
    ...
    protected abstract TContext BuildContext(SampleType sampleType);

    public virtual async Task<TContext> LoadDatasetData(DatasetCriteria model, params Data.Entities.Omics.Analysis.Enums.AnalysisType[] analysisTypes)
    {
    ...
    protected virtual async Task<TContext> LoadDonorsDatasetData(DatasetCriteria model, params Data.Entities.Omics.Analysis.Enums.AnalysisType[] analysisTypes)
    {
        ...
        var sampleIds = await _specimenRepository.GetRelatedSamples(specimenIds, /* analysisTypes*/ new Data.Entities.Omics.Analysis.Enums.AnalysisType[0]);
