using Unite.Analysis.Services.DonSce.Models.Context;
using Unite.Analysis.Services.DonSce.Models.Criteria;
using Unite.Analysis.Services.DonSce.Models.Input;

namespace Unite.Analysis.Services.DonSce;
